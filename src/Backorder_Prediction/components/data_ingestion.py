...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            df_train.to_csv(self.ingestion_config.raw_train_data_path, index=False, header=True)
            ...
            df_test.to_csv(self.ingestion_config.raw_test_data_path, index=False, header=True)
